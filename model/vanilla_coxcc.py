...
method = 'vanilla_cox_cc'
data = 'rr_nl_nph'

df = load_data('./data/rr_nl_nph.pkl')
...
np.savetxt('/home/zeren/Research/Cox/output/vanilla_coxcc_coverage_'+data+str(epochs)+'.txt',np.array(coverage))
np.savetxt('/home/zeren/Research/Cox/output/vanilla_coxcc_censor_coverage_'+data+str(epochs)+'.txt',np.array(coverage_censor))
np.savetxt('/home/zeren/Research/Cox/output/vanilla_coxpcc_non_censor_coverage_'+data+str(epochs)+'.txt',np.array(coverage_non_censor))